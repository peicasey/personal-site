...
const Navbar = () => {
  ...
  return (
    <NavigationMenu.Root className="fixed z-[102] flex w-screen py-2 px-4 m-0 top-0 justify-between backdrop-blur">
      ...
      <NavigationMenu.List className="right text-sm sm:text-md shadow-blackA7 m-0 flex items-center list-none rounded-[6px] backdrop-blur-2xl p-1 before:hidden">
        <NavigationMenu.Item>
          <NavigationMenu.Trigger onClick={() => navigate('/about')} className="text-amber11 dark:text-amber-500 hover:bg-neutral-100 dark:hover:bg-neutral-800 focus:shadow-amber7 group flex select-none items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 font-medium leading-none outline-none focus:shadow-[0_0_0_2px]">
            <p className='text-sm sm:text-md'>About{' '}</p>
            <CaretDownIcon
              className="text-amber11 relative top-[1px] transition-transform duration-[250] ease-in group-data-[state=open]:-rotate-180"
              aria-hidden
            />
          </NavigationMenu.Trigger>
          <NavigationMenu.Content className=" z-[100] data-[motion=from-start]:animate-enterFromLeft data-[motion=from-end]:animate-enterFromRight data-[motion=to-start]:animate-exitToLeft data-[motion=to-end]:animate-exitToRight absolute top-0 left-0 w-full sm:w-auto">
        ...
        <NavigationMenu.Item>
          <NavigationMenu.Trigger onClick={() => navigate('/projects')} className="text-amber11 dark:text-amber-500 hover:bg-neutral-100 dark:hover:bg-neutral-800 focus:shadow-amber7 group flex select-none items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 leading-none outline-none focus:shadow-[0_0_0_2px]">
          ...
          <NavigationMenu.Content className="absolute z-[100] top-0 left-0 w-full sm:w-auto">
        ...
        <NavigationMenu.Item>
          <NavigationMenu.Trigger onClick={() => navigate('/experience')} className="text-amber11 dark:text-amber-500 hover:bg-neutral-100 dark:hover:bg-neutral-800 focus:shadow-amber7 group flex select-none items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 text-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]">
            <p className='text-sm sm:text-md'>Experience{' '}</p>
            <CaretDownIcon
              className="text-amber11 relative top-[1px] transition-transform duration-[250] ease-in group-data-[state=open]:-rotate-180"
              aria-hidden
            />
