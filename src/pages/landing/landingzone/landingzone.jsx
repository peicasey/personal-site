    ...
    <div className="bg-[#ffc846] dark:bg-[#0c0b09] pt-10 overflow-hidden w-[100vw] h-[100vh]">
       ...
       <div className="absolute flex flex-col sm:flex-row justify-between duration-200">
          ...
          <div className="relative w-auto md:w-2/4 m-20 mr-10">
              <div className="animation-fadeUp100 relative mb-4">
                  <div >
              ...
              <div className="animation-fadeUp200 md:w-full w-[31vw]">            
      ...
      <div className='w-[100vw] h-full flex flex-col items-end sm:flex-row justify-center sm:justify-between'>
        ...
        <div className='group hover:cursor-grab w-[60vw] h-full absolute md:top-0 right-0 md:right-auto left-auto md:left-[-12vw]'>
