    ...
    <div className="bg-[#ffc846] dark:bg-[#0c0b09] pt-4 overflow-hidden w-[100vw] h-[100vh]">
      ...
      <div className=" flex flex-col sm:flex-row justify-between duration-200">
        <div className="hidden sm:block"></div>
          <div className="relative w-auto md:w-2/4 mt-16 sm:mt-20 ml-12 sm:m-20 mr-8">
      ...
      <div className='absolute top-0 w-[100vw] h-full flex flex-col items-end sm:flex-row justify-center sm:justify-between'>
